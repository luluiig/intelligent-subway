<!--
 * @Description: 路径规划展示面板(子组件)
 * @Author: lijialu lijialu0810@163.com
 * @Date: 2024-06-27 23:49:14
 * @LastEditors: lijialu lijialu0810@163.com
 * @LastEditTime: 2024-06-28 01:46:05
 * @FilePath: \wisdom-subway-system\src\components\RouteDes\PathDesignDisplayCard.vue
-->
<template>
  <div class="display-card">
    ...
    <a-card
      title="路线概览"
      style="margin-bottom: 10px; background: transparent; color: #eee"
      :bordered="false"
      size="small"
    >
      <div class="header">
        ...
        >
          {{ distanceTotal }}
          <span style="font-size: 12px; color: #ddd">公里</span>
        </div>
      </div>
    </a-card>
    <!-- 线路详情 -->
...
import { focusOnStation } from "@/cesiumTools/myFramwork/home/effectController.js";
